function time_map = time_mapping(YYY, THETA, h_user, data)

% Setup
TT = data.walker(1);             % total number of satellites
Nplanes = data.walker(2);              % number of planes
n_sat = TT/Nplanes;
        ...
        for la = 1 : n_lat
            ...
            for ii = 1 : Nplanes
                for kk = 1 : n_sat
                    ...
                    kkk = coverageNumber(lon, lat, data.tspan(jj), instant_states((ii-1)*n_sat + kk, :),...

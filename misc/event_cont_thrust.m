...
%     end
    ...
    delta_v_actual = parameters.Isp * 9.81* log(parameters.M0/(parameters.M0 - x(7)));
    eclipse = 1;
    %check on position 
    value = [rSOI - r_sc_norm; eclipse; (t_seconds - t0sym) - t_BO; } %delta_v_actual - parameters.delta_v_req]; 
